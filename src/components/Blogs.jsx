const Blogs = () => {
  ...
  return (
    <section id="blogs" className="py-20 px-4" aria-label="Technical blogs on AI and machine learning by Ashok Lamsal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {blogs.map((blog) => (
            ...
            >
              ...
              <p className="text-sm text-gray-500 dark:text-gray-500 mt-3">Article coming soon</p>
            </article>
          ))}
        </div>
      </div>
